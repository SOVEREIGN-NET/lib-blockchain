...
pub mod hashing;
pub mod signing;
pub mod mesh_sync;  // NEW: Mesh synchronization transactions
...
// Re-export mesh sync types
pub use mesh_sync::{
    MeshSyncTransaction, ValidatorSignature, MerkleBatchProof, 
    MerklePathProof, MeshSyncMetadata, SyncReason,
};
